...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function createErrorElement(fieldName) {
            let errorEl = document.querySelector(`[data-error="${fieldName}"]`);
            if (!errorEl) {
        ...
        function showError(input, message) {
            const errorEl = createErrorElement(input.name);
        ...
        function validateField(input) {
            ...
            if (input.type === 'email' && value) {
                ...
                if (!emailPattern.test(value)) {
                    showError(input, rules.pattern);
                    return false;
                }
            }

            if (input.tagName === 'TEXTAREA' && input.hasAttribute('minlength') && value.length < parseInt(input.getAttribute('minlength'))) {
                showError(input, rules.minlength);
                return false;
            }
            ...
            if (isValid) {
                ...
                if (submitButton) {
                    ...
                    .catch(function() {
                        ...
                        errorMessage.className = 'form-error form-error--global';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7e3cab8b-c3d1-4f21-bb6f-401c83af4fff',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7e3cab8b-c3d1-4f21-bb6f-401c83af4fff';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7e3cab8b-c3d1-4f21-bb6f-401c83af4fff';
